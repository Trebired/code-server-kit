...
const PACKAGE_NAME = toTrimmedString(packageJson?.name) || `@${PACKAGE_ORGANIZATION_NAME}/code-server-kit`;
const PACKAGE_VERSION = toTrimmedString(packageJson?.version, "1.5.2");
